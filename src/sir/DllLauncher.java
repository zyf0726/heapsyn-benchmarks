...
public class DllLauncher {
	...
	private static void init() throws ClassNotFoundException {
		cls$List = Class.forName("sir.dll.DoubleLinkedList");
		cls$Entry = Class.forName("sir.dll.DoubleLinkedList$Entry");
		cls$Iter = Class.forName("sir.dll.DoubleLinkedList$ListItr");
	}

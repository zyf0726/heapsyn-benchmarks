...
public class BinomialLauncher {
	...
	private static final int scopeForHeap$Node	= 6;
	...
	private static void init() throws ClassNotFoundException {
		cls$Heap = Class.forName("javascan.binomial.BinomialHeap");
		cls$Node = Class.forName("javascan.binomial.BinomialHeap$BinomialHeapNode");
	}
